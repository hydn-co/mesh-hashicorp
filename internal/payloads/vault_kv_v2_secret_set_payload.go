...
type VaultKVV2SecretSetPayload struct {
	MountPath  string          `json:"mount_path"    binding:"required" title:"Mount Path"            description:"The Vault KV v2 mount path that stores the secret."                                                   x-lookup:"{\"entity-type\": \"secrets\", \"display-key\": \"name\", \"submit-key\": \"group_ref\", \"form-input-type\": \"multi-select\"}"`
